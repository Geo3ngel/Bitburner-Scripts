...
export const PURCHASING_EXPLOIT = 1;
export const PURCHASING_SERVER = 2;
export const PURCHASING_HACK_NET_NODE = 3;
export const PURCHASING_AUGMENTATION = 4;
export const PURCHASING_HOME_UPGRADE = 5;
 ...
 * #######################################
 */
const EXPLOIT_CHECK = 0; // Deprecated. To be removed
const LVL_UP_CHECK = 1;
const PRIME_ATTACK = 2;
const PURCHASE_PHASE = 3;